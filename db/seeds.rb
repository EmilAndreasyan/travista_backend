...
@usa = Country.create(user: @user1, id: 1, name: 'USA', capital: 'Washington', language: 'English', currency: 'US dollar', area: 3797000000, flag_url: 'https://upload.wikimedia.org/wikipedia/commons/f/ff/United-States-orb.png')

@france = Country.create(user: @user1, id: 2, name: 'France', capital: 'Paris', language: 'French', currency: 'Euro', area: 248573, flag_url: 'https://upload.wikimedia.org/wikipedia/commons/d/db/FranceFlag-ico.png')

@italy = Country.create(user: @user1, id: 3, name: 'Italy', capital: 'Rome', language: 'Italian', currency: 'Euro', area: 116347, flag_url: 'https://www.shareicon.net/data/256x256/2015/04/16/23636_flag_256x256.png')
